...
- 💵 [Become a **sponsor** and **advertise your site**](https://www.patreon.com/cushen)
...
In the future, [we plan to extend support for emojis and custom SVG icons to other Academic components](https://github.com/gcushen/hugo-academic/issues/1698).In the future, [we plan to extend support for emojis and custom SVG icons to other Academic components](https://github.com/gcushen/hugo-academic/issues/1698).
