...
Hugo v0.60 has a bug which breaks the Table of Contents shortcode. There is a workaround documented [here](https://sourcethemes.com/academic/docs/writing-markdown-latex/#table-of-contents). The table of contents that is built into the `docs` layout is unaffected by this Hugo bug.

### Slides

Hugo v0.60 appears to have a bug which breaks the Slides feature. You can add `markup: blackfriday` in the front matter of slide decks to workaround the issue.
