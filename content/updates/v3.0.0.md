...
- New responsive **featured image system** with automatic resizing - simply drag an image named `featured.*` to a pages own folder to add a featured image to a page
  - resize your browser window whilst viewing the [demo](https://themes.gohugo.io/theme/academic/) to see how it looks on different devices
- New **streaming layout** for widgets - display a brief summary and thumbnail of each item
...
- Migrate to Hugo's new page bundles - each page gets its own folder where assets can be easily drag-and-dropped
- Migrate from Font Awesome v4 to v5
- Migrate from Bootstrap v3 to v4
